...
function inicializarValidaciones() {
    ...
    forms.forEach((form) => {
        form.addEventListener("submit", async function (event) {
            ...
            const type_sensors = document.querySelector('.type_sensors');
            const name_sensors = document.querySelector('.name_sensors');
            const unit_sensors = document.querySelector('.unit_sensors');
            const time_sensors = document.querySelector('.time_sensors');
            ...
            inputs.forEach((input) => {
                ...
                let datos = {
                    type_sensors: type_sensors ? type_sensors.value : '',
                    name_sensors: name_sensors ? name_sensors.value : '',
                    unit_sensors: unit_sensors ? unit_sensors.value : '',
                    time_sensors: time_sensors ? time_sensors.value : ''
